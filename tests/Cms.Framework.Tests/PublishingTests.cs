...
public sealed class PublishingTests : IDisposable
{
    ...
    {
        var created = _fixture.Repository.Create(new NewsContent { Name = "A", Heading = "H", Body = "B", Color = "red" }, "en");
    ...
    {
        var news = _fixture.Repository.Create(new NewsContent { Name = "N", Heading = "H", Body = "B", Color = "red" }, "en");
        var @event = _fixture.Repository.Create(new EventContent { Name = "E", Title = "T", Description = "D", StartDate = DateTime.UtcNow }, "en");
        var unpublishedNews = _fixture.Repository.Create(new NewsContent { Name = "N2", Heading = "H2", Body = "B2", Color = "green" }, "en");
